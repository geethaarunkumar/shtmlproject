...
<?php
	...
	class View
	{
			...
			{
			echo $this->model->name . $this->model->email . $this->model->tel . $this->model->msg;
			}
	}
	class Controller
	{
...
//	$model =new Model();
				...
				{	
$model=new Model($_REQUEST['name']."<br/>",$_REQUEST['email']."<br/>",$_REQUEST['tel']."<br/>",$_REQUEST['msg']."<br/>");
$view =new View($model);
